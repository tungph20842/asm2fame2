...
const Details = () => {
  ...
  return (
    ...
    <div className="logo_section py-10">
      <div className="container">
        <div className="row">
          <div className="col-sm-12">
    ...
    <h2 className="font-bold text-5xl">chi tiết sản phẩm</h2>
    </div>
    <div className="flex justify-center space-x-5 py-10">
      {isLoading ? (
        <Skeleton active />
      ) : (
        <Card title={productData?.name} style={{ width: 300 }}>
          <img src={productData?.image} alt={productData?.name} style={{ width: "100%" }} />
